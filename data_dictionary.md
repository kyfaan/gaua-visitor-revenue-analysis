...
• Basically it tells to check BETWEEN bigquery-public-data.google_analytics_sample.ga_sessions_20170801 AND bigquery-public-data.google_analytics_sample.ga_sessions_20170831 only. If 'date' is used in WHERE, we query all tables that contain between 20170801 and 20190831.
